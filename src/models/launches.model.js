...
async function getAllLaunches(skip, limit) {
  ...
  return await launchesDatabase
    ...
    .sort({ flightNumber: 1 }) //sorting flight number asc
    .skip(skip) //untuk melewati sekian data pada halaman selanjutnya (2 or more)
    .limit(limit); //limit adalah banyaknya data yang muncul pada setiap page
}
